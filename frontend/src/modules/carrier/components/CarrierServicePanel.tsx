...
type ServiceUpdateValues = Omit<ServiceCreateValues, 'serviceCode'>
  ...
  return (
    <div className="space-y-6">
      <Card className="space-y-4 border border-border/70 p-4 shadow-sm">
        <div>
          <p className="text-base font-semibold">新增服务</p>
        ...
        <Form {...createForm}>
          ...
          >
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="如：LAST_MILE" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="可选，供区域引用" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
            ...
            <div className="flex justify-end">
              ...
              >
                {createForm.formState.isSubmitting ? '保存中...' : '创建服务'}
              </Button>
            </div>
          </form>
        </Form>
